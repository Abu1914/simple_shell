...
/**
 * _check_env - checks the typed variable is an env variable
 *
...
/**
 * _checkvars - Checked if the typed variable is $$ or $?
 *
...
/**
 * _replacedinput - replaces string into variables
 *
 * @h: head of the linked list
 * @input: input string
...
/**
 * _repvar - Calls functions to replace strings into vars
 *
 * @input: input string
 * @data: data structure
 * Return: replaced string
